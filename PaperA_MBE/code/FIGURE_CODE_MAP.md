...
| Figure 7 (integrative answer: subset disjointness, universe-background enrichment, GWAS anchoring, coverage sensitivity; 4 panels) | `Figure7_integrative_answer.pdf` | `paperA_fig7.py` (reads `expected_outputs/phase9_hardening/` CSVs generated by `code/analysis/phase9_tier{1,2,3,4}_*.py`) |
