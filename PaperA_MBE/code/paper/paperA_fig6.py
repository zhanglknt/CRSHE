# -*- coding: utf-8 -*-
"""
Paper A (MBE) — Figure 6: Independent evidence and cross-study context (6 panels, 2x3)
=======================================================================================
...
Output: results/paper/figures_v2/Figure6_independent_evidence.png (300 dpi) + .pdf
...
out_png = os.path.join(OUTDIR, "Figure6_independent_evidence.png")
out_pdf = os.path.join(OUTDIR, "Figure6_independent_evidence.pdf")
