# -*- coding: utf-8 -*-
"""
Paper A (MBE) — Figure 5: Functional content of the classes
(6 panels, 2x3). Output: results/paper/figures_v2/Figure5_class_functional_content.
...
# ----------------------------------------------------------------- save ----
fig.savefig(os.path.join(OUTDIR, "Figure5_class_functional_content.png"),
            dpi=300)
fig.savefig(os.path.join(OUTDIR, "Figure5_class_functional_content.pdf"),
            bbox_inches="tight")
plt.close(fig)

print("PaperA Figure 5 written to", OUTDIR)
for s in summary:
    print("  " + s)
